      ...
      try {
        ...
        if (!existingInsights || existingInsights.length === 0) {
          ...
          for (const insightData of sampleInsights) {
            ...
            console.log(`  ✅ Created: ${insightData.title}`);
          }
        } else {
          console.log('📝 Insights already exist, skipping...');
        }
        ...
        if (!existingStats) {
          ...
          console.log('  ✅ Created default stats');
        } else {
      ...
      if (publicRole) {
        ...
        for (const actionPath of actionsToEnable) {
          ...
          if (permission && !permission.enabled) {
            ...
            console.log(`✅ Enabled public access: ${actionPath}`);
          } else if (permission) {
            console.log(`ℹ️  Already enabled: ${actionPath}`);
          } else {
            console.log(`⚠️  Permission not found: ${actionPath}`);
          }
        }
      }
    } catch (error) {
